...
const Topheader = () => {
    return (
        <div className="topheader  pl-10 lg:pl-28  flex  overflow-hidden md:h-89 ">
            ...
            <div className="relative rotate-10 ">
                <img src='/images/bg-intro-desktop.svg' className=" absolute -top-60 left-25  max-w-450 w-250 h-200  " />
