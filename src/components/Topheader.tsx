...
const Topheader = () => {
    return (
        <div className="topheader  pl-10 lg:pl-28  flex gap-10 overflow-hidden md:h-89 ">
            ...
            <div className="relative md:h-89 -top-45 left-72 w-fit">
                <img src='/images/bg-intro-desktop.svg' className=" w-350  " />
